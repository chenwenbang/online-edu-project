    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descri', models.CharField(max_length=300, verbose_name='\u8bfe\u7a0b\u7b80\u4ecb')),
                ('detail', models.TextField(max_length=1000, verbose_name='\u8bfe\u7a0b\u8be6\u60c5')),
                ...
                ('teacher_tell_you', models.CharField(default='', max_length=300, verbose_name='\u8001\u5e08\u544a\u8bc9\u4f60')),
                ('is_banner', models.BooleanField(default=False, verbose_name='\u662f\u5426\u8f6e\u64ad')),
                ('org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='orgnizations.CourseOrg', verbose_name='\u8bfe\u7a0b\u673a\u6784')),
                ('teacher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='orgnizations.Teacher', verbose_name='\u8bb2\u5e08')),
            ],
            options={
                'verbose_name': '\u8bfe\u7a0b',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
                ('url', models.CharField(default='', max_length=300, verbose_name='\u89c6\u9891\u5730\u5740')),
